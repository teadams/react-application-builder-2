export const fieldsForObjectType: Record<string, any> = {
    atsJob: ["name", "departments", "status", "offices", "hiring_managers","recruiters","job_posting_urls","createdAt"],
    candidates: ["first_name","last_name","company","title","email_addresses","applications","createdAt"],
    atsApplication: ["job","current_stage","applied_at","rejected_at","source","candidate","credited_to","createdAt"],
    atsJobStage: ["name","job","createdAt"],
